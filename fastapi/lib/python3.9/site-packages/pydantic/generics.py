...
# _assigned_parameters is a Mapping from parametrized version of generic schema to assigned types of parametrizations
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        # schema that should be identical.
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    # We handle pydantic generic schema separately as they don't have the same
